...
import com.example.gerfoxmessages.settings.SettingsGroups
import com.example.gerfoxmessages.ui.message_recycleView.views.AppViewFactory
...
class GroupChat(private val group: CommonModel) : Base(R.layout.fragment_single_chat) {
    ...
    private fun initInfoToolbar() {
        ...
        mToolbarInfo.toolbar_image_chats.downloadAndSetImage(group.photoURL)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.info_btn_action_bar -> {
                replaceFragment(SettingsGroups())
            }
